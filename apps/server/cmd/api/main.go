...
// learned that in Go we should pretty much separate everything as much as possible
// this is probably a more idiomatic way to learn Go
//
...
func main() {
	...
	// http.HandleFunc("/sessions/keys", sessionKeyHandler)
